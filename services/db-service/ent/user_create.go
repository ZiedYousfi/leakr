...
func (uc *UserCreate) SetIsSubscribed(b bool) *UserCreate {
	uc.mutation.SetIsSubscribed(b)
	return uc
}

// SetNillableIsSubscribed sets the "is_subscribed" field if the given value is not nil.
func (uc *UserCreate) SetNillableIsSubscribed(b *bool) *UserCreate {
	if b != nil {
		uc.SetIsSubscribed(*b)
	}
	return uc
}

// SetSubscriptionTier sets the "subscription_tier" field.
func (uc *UserCreate) SetSubscriptionTier(s string) *UserCreate {
	uc.mutation.SetSubscriptionTier(s)
	return uc
}

// SetNillableSubscriptionTier sets the "subscription_tier" field if the given value is not nil.
func (uc *UserCreate) SetNillableSubscriptionTier(s *string) *UserCreate {
	if s != nil {
		uc.SetSubscriptionTier(*s)
	}
	return uc
}
...
func (uc *UserCreate) AddSubscription(s ...*Subscription) *UserCreate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
...
func (uc *UserCreate) defaults() {
	...
	if _, ok := uc.mutation.IsSubscribed(); !ok {
		v := user.DefaultIsSubscribed
		uc.mutation.SetIsSubscribed(v)
	}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.IsSubscribed(); !ok {
		return &ValidationError{Name: "is_subscribed", err: errors.New(`ent: missing required field "User.is_subscribed"`)}
	}
	if _, ok := uc.mutation.SubscriptionTier(); !ok {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.IsSubscribed(); ok {
